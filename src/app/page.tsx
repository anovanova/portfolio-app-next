  ...
  return (
    <div className={newsreaderFont.className}>
      <header className="fixed top-0 z-50 w-screen">
        <div className="flex h-auto w-full flex-col bg-blueCustom md:h-16 md:flex-row md:justify-between">
          <div className="flex items-center justify-between p-4 pl-4 text-gray-200 md:pl-16">
            <div className="text-center">
              <a href="#introduction" className="text-3xl font-semibold text-gray-200 md:text-4xl">
                M.A
              </a>
            </div>
          ...
          <div
            className={`border-bottom ${showNav ? 'h-60 opacity-100' : 'h-0 opacity-0'} flex flex-col items-center gap-8 overflow-hidden transition-all duration-150 ease-in-out sm:opacity-100 md:flex md:h-auto md:flex-row md:justify-end md:px-16`}
          >
            ...
            <div className="w-full sm:w-auto">
              <button
                onClick={() => window.open('/Michael Acedera.pdf')}
                className="w-full bg-khaki p-2 font-semibold text-gray-800 transition ease-in-out hover:bg-khakiHover sm:w-auto"
              >
                View CV
              </button>
            </div>
      ...
      <div className="flex place-content-center bg-blueCustom">
        <div className="max-w-[1920px]">
          <div id="introduction" className="grid h-screen bg-blueCustom">
            <div className="grid gap-6 px-8 py-24 text-5xl text-gray-200 md:px-16">
              <div className="grid gap-6">
                <div>
                  <h1 className="text-[70px] text-gray-100 md:text-[120px] 2xl:text-[180px]">
                    Michael Acedera
                  </h1>
                </div>
                <div>
          ...
          <div id="aboutMe" className="grid bg-blueCustom sm:h-auto sm:w-full lg:h-screen">
            <div className="grid gap-6 px-8 py-24 text-5xl text-gray-200 sm:px-16">
              <div>
                <div className="flex">
                  <h1 className="border-b-4 border-b-khaki text-[60px] text-gray-100 md:text-[100px] 2xl:text-[130px]">
                    About Me
                  </h1>
                </div>
                <div className="m-5 my-16">
                  <p className="indent-10 text-[30px] leading-[1.2] md:text-5xl 2xl:text-6xl">
                    I&apos;m a full-stack web developer, with over{' '}
                    <span className="font-semibold text-khaki">2 years of work experience,</span>{' '}
                    I&apos;ve added features, and maintain web apps that uses the following:{' '}
                    <span className="font-semibold text-khaki">
                      React, Vue, Typescript, JQuery, PHP, Laravel, and Node,
                    </span>{' '}
                    also I have experience on the following databases:{' '}
                    <span className="font-semibold text-khaki">MySQL, and PostgreSQL,</span> also I
                    have experience on{' '}
                    <span className="font-semibold text-khaki">GraphQL, and Prisma.</span>
                  </p>
                </div>
              </div>
            </div>
          </div>
          <div id="workExp" className="grid bg-blueCustom sm:h-auto lg:h-screen">
            <div className="grid gap-6 px-8 py-24 text-5xl text-gray-200 sm:px-16">
              <div>
                <div className="flex">
                  <h1 className="border-b-4 border-b-khaki text-[60px] text-gray-100 md:text-[100px] 2xl:text-[130px]">
                ...
                <div className="m-5 my-16">
                  <div className="grid grid-cols-1 gap-16 md:grid-cols-2 md:gap-4">
                    <div>
                      <h2 className="text-[50px] md:text-6xl 2xl:text-7xl">
                        <span className="px-2 font-semibold text-khaki">Placer8</span>
                      </h2>
                      <div className="p-2">
                        <ul className="flex list-disc flex-col gap-4 text-[30px] md:text-4xl 2xl:text-5xl">
                          <li>
                            Building full-stack websites for Clients using HTML, CSS, JavaScript,
                            and PHP
                          </li>
                    ...
                    <div>
                      <h2 className="text-[50px] md:text-6xl 2xl:text-7xl">
                        <span className="px-2 font-semibold text-khaki">
                      ...
                      <div className="p-2">
                        <ul className="flex list-disc flex-col gap-4 text-[30px] md:text-4xl 2xl:text-5xl">
                          ...
                          <li>
                            Creating Web Apps using the following Tech Stack, ReactJS, Fastify,
                            PostgreSQL
                          </li>
                        </ul>
                      </div>
          ...
          <div id="projects" className="grid bg-blueCustom sm:h-auto lg:h-screen">
            <div className="grid gap-6 px-8 py-24 text-5xl text-gray-200 sm:px-16">
              <div>
                <div className="flex">
                  <h1 className="border-b-4 border-b-khaki text-[60px] text-gray-100 md:text-[100px] 2xl:text-[130px]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    <div>
                      <div className="relative">
                        <a
                          target="_blank"
                          href="https://github.com/anovanova/project-task-tracker-laravel"
                        >
                          <img src="TaskTrackerImg.png" alt="" />
                          <div className="absolute top-0 grid h-full w-full place-content-center bg-black/70 opacity-0 transition ease-in-out hover:opacity-100">
                            <svg
                              width="50"
                              height="50"
                              viewBox="0 0 24 24"
